...
where $$I(v(t) = v'(t))$$ here is equal to 1 if the condition $$v(t) = v'(t)$$ is true, and 0 if false. $$v'(t)$$ is obtained from a possible boolean expression that maps the inferred input nodes at time \emph{t} with the target node at $$v'(t)$$. 
